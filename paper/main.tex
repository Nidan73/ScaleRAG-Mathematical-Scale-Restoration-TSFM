...
%      figures/        fig1_motivation.pdf ... fig6_sensitivity.pdf
%
%  Build:  pdflatex main -> bibtex main -> pdflatex main -> pdflatex main
%
%  Requires svjour3.cls and spmpsci.bst from the Springer Nature LaTeX
%  template (present by default on Overleaf's Springer template; not shipped
%  here). Tables that span both columns use table*, as the class is twocolumn.
%
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{figures/fig3_qualitative.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{figures/fig4_regimes.pdf}
