...
In contrast to all of the above, our approach directly confronts the numerical brittleness of Euclidean k-NN. Rather than bypassing raw similarity via latent embeddings or semantic text, we introduce explicit mathematical scale restoration. This provides a deterministic, computationally lightweight solution to scale hallucination whose retrieval and restoration stages introduce no trainable parameters.
